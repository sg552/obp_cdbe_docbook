...
%docbook_libxslt_path%\xsltproc.exe --stringparam use.extensions 0  --stringparam  fop.extensions 1 --timing --xinclude --output %docbook_outputdir%\%1.fo   %docbook_use_stylesheet%  %docbook_books_path%\%1\%2\src\%1.xml 
