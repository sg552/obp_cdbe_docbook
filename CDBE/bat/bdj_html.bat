...
java.exe %docbook_java_parameters% -cp "%classpath%"  %using_xerces% com.icl.saxon.StyleSheet %using_catalog% -o %docbook_outputdir%\%1.html %docbook_books_path%\%1\%2\src\%1.xml %docbook_use_stylesheet%
